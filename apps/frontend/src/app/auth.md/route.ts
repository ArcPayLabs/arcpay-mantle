...
const body = `# Auth.md - ArcPay Mantle auth

ArcPay supports wallet-first operator access and hosted MCP developer keys.

## Human operators

1. Open https://arcpay-mantle.vercel.app/sign-in
2. Connect an EVM wallet on Mantle Testnet or use an existing email workspace.
...
- register_uri: https://arcpay-mantle.vercel.app/agent/auth
- claim_uri: https://arcpay-mantle.vercel.app/agent/auth/claim
- claim_complete_uri: https://arcpay-mantle.vercel.app/agent/auth/claim/complete
- revocation_uri: https://arcpay-mantle.vercel.app/agent/auth/revoke
- Protected Resource Metadata: https://arcpay-mantle.vercel.app/.well-known/oauth-protected-resource
...
8. Call https://arcpay-mantle.vercel.app/api/mcp with Authorization: Bearer <key>.
