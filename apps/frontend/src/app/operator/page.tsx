    ...
    <>
      ...
      <section className="grid section">
        {!DEPTH_CONTRACTS_READY ? (
          <div className="panel full notice">OperatorControls is compiled and tested but not deployed in the current address file. Top up the deployer and run `npm run deploy:mantle`.</div>
        ) : null}
        <div className="panel">
