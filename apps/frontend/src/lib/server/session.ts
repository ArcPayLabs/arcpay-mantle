...
const SESSION_COOKIE = "arcpay_mantle_session";
const CHALLENGE_COOKIE = "arcpay_mantle_challenge";
const SESSION_TTL_SECONDS = 7 * 24 * 60 * 60;
const CHALLENGE_TTL_SECONDS = 5 * 60;

function secret() {
  return process.env.ARCPAY_SESSION_SECRET ?? "arcpay-mantle-dev-secret";
}
