...
const ITEMS = [
  ...
  { title: "Agents", url: "/agents", icon: Bot, networks: ["mantle"] },
  { title: "Orders", url: "/orders", icon: Workflow, networks: ["mantle"] },
  { title: "x402", url: "/x402", icon: RadioTower, networks: ["mantle"] },
  { title: "RealClaw", url: "/realclaw", icon: Cable, networks: ["mantle"] },
  { title: "Cards", url: "/cards", icon: CreditCard, networks: ["mantle"] },
  ...
  { title: "Oracle", url: "/oracle", icon: Gauge, networks: ["mantle"] },
