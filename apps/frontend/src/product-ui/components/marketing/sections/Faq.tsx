...
const FAQS = [
  ...
  },
  {
    ...
    a: "ArcPay records the action as a governed intent or blocks it with policy feedback. Swap and yield pages stay in intent mode until native Mantle rails are deployed.",
  },
  {
    q: "Can I export an audit report?",
    a: "Yes. The audit page exports local and mirrored action records, including transaction hashes where a Mantle contract write happened.",
  },
];
