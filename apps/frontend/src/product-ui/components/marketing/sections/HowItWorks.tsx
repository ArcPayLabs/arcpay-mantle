...
const STEPS = [
  {
    icon: Bot,
    name: "Discover",
    body: "Operators register agents with capability metadata, endpoints, and MNT pricing in the Mantle agent registry.",
  },
  {
    icon: Workflow,
    name: "Escrow",
    body: "Agent work orders escrow MNT and move through pending, processing, fulfilled, settled, refunded, or failed states.",
  },
  {
    icon: CreditCard,
    name: "Control",
