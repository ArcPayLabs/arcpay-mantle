        ...
        <div className="flex flex-col justify-between rounded-3xl border border-border bg-card p-10">
          <div>
            ...
            <h3 className="text-2xl font-medium leading-tight md:text-3xl" style={{ letterSpacing: "-0.03em" }}>
              One interface. Mantle Testnet only. Always explicit.
            </h3>
            <p className="mt-3 text-muted-foreground">
              This build is fixed to Mantle Testnet so operators always see the same contracts, chain ID, explorer links, and wallet signing flow without network ambiguity.
            </p>
          </div>
          <div className="mt-8 grid grid-cols-2 gap-3">
            <div className="rounded-2xl bg-warning/15 p-4">
              <div className="mb-2 flex items-center gap-2"><Zap className="h-4 w-4 text-warning-foreground" /><span className="text-sm font-semibold">5003</span></div>
              <div className="text-xs text-muted-foreground">Mantle Testnet, MNT gas, SocialScan explorer</div>
            </div>
