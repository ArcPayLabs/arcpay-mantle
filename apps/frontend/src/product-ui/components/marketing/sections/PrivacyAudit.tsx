      ...
      <div className="mx-auto grid max-w-[88rem] grid-cols-1 gap-4 lg:grid-cols-[1.1fr_1fr]">
        <div className="rounded-3xl border border-border bg-card p-10">
          <SectionHeading
            ...
            description="ArcPay includes a MantlePrivacyVault contract for commitment-based payment intents, encrypted memo pointers, and selective disclosure records."
          />
        ...
        <div className="flex min-h-[420px] flex-col justify-between rounded-3xl bg-surface-dark p-10 text-surface-dark-foreground ap-grid-bg">
          ...
          <div>
            <p className="text-2xl font-medium leading-snug md:text-3xl" style={{ letterSpacing: "-0.025em" }}>
              "Mantle agents need privacy-aware payment coordination. ArcPay ships a reusable privacy-intent layer operators and agent builders can build on."
            </p>
