  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Review Mantle builders, invite operators, and track active beta testers from the production signup table."
        actions={
          ...
          {!rows.length ? (
            <div className="p-6">
              <EmptyState
                ...
                description="Change the filter or share /beta with Mantle builders."
              />
            </div>
          ) : null}
        </div>
