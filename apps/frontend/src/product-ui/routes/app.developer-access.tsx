...
function DeveloperAccessRoute() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Issue scoped keys for Claude, Cursor, agent runners, or HTTP clients that need ArcPay Mantle MCP tools without exposing the global server token."
        actions={
  ...
  "mcpServers": {
    "arcpay-mantle": {
      ...
      "headers": {
        "Authorization": "Bearer ap_mantle_..."
      }
    }
  }
}`}</pre>
