...
import { agentIdFromSlug, reputationBookContract, shortAddress, writeRecord } from "@mantle/lib/mantle";
...
function ReputationRoute() {
  ...
  const [status, setStatus] = useState("Record reputation only after a real Mantle order reaches fulfilled, settled, refunded, or failed state.");
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        eyebrow="Agent trust"
        title="Reputation"
        description="Record order-backed reputation for Mantle agents. Only order participants can review, and duplicate reviews are blocked on-chain."
      />
