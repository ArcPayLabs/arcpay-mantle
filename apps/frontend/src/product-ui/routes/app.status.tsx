  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        title="ArcPay Mantle system health."
        description="Live checks for the Mantle RPC, deployed contracts, x402 gateway, Mintlify docs, and worker-indexed audit records."
        actions={
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <StatCard icon={Server} label="Network" value={status?.network.chainId ?? "--"} hint={status?.network.name ?? "Mantle Testnet"} />
