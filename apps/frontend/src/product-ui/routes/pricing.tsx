...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Simple, transparent pricing for AI-agent treasuries on Mantle." },
      ...
      <div className="px-6 pt-16 pb-24">
        <div className="max-w-[88rem] mx-auto">
          <SectionHeading
            ...
            description="The Mantle testnet version is free to use while ArcPay hardens hosted infrastructure, observability, and production support."
          />
