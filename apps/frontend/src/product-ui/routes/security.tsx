...
export const Route = createFileRoute("/security")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How ArcPay handles custody, signing, privacy intents, policy, and audit on Mantle." },
      { property: "og:title", content: "Security - ArcPay" },
      { property: "og:description", content: "Custody, signing, privacy intents, policy, and audit on Mantle." },
    ],
  }),
...
const ITEMS = [
  {
    icon: ShieldCheck,
    title: "Non-custodial",
    body: "ArcPay never holds keys. Signing happens in the connected Mantle EVM wallet before contract writes or payment intents proceed.",
  },
  {
    icon: KeyRound,
  ...
  },
  {
    ...
    body: "Agent registry, order, card, payment, policy, privacy, and oracle actions are recorded with transaction hashes where a Mantle write occurred.",
  },
  {
    icon: AlertTriangle,
    title: "Policy-enforced spend",
    body: "Hourly, daily, and weekly limits, approval thresholds, allowed tokens, blocked actions, minimum Mantle risk score, contractor allowlist, and emergency pause.",
  },
  {
    icon: ServerCog,
      ...
      <div className="px-6 pb-24 pt-16">
        <div className="mx-auto max-w-[88rem]">
          <SectionHeading
            ...
            description="ArcPay is a control plane, not a custodian. We separate live Mantle Testnet contracts, wallet signatures, and hosted infrastructure responsibilities clearly."
          />
