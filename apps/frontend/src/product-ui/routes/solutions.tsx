...
const SOLUTIONS = [
  {
    ...
    body: "Register service agents, publish capabilities, price work in MNT, and let other operators or agents create escrowed orders.",
  },
  {
    icon: Briefcase,
      ...
      <div className="px-6 pt-16 pb-24">
        <div className="max-w-[88rem] mx-auto">
          <SectionHeading
            ...
            description="ArcPay is a Mantle product surface for agent operators, builders, and treasury teams that need controlled autonomous execution."
          />
