---
title: "Roadmap"
description: "What ships next for ArcPay Mantle."
---
...
- collect feedback from Mantle builders running testnet agents
...
- publish a reusable starter kit for x402 paid Mantle agents
...
## Phase 3: Deeper Mantle-Native Agent Infrastructure
...
- add Mantle Reactivity subscriptions for order, invoice, card, policy, and privacy events
- add Mantle Data Streams schemas for agent reputation, service telemetry, and beta usage
- add more Mantle-native DeFi hooks as stable testnet router/vault infrastructure matures

## Phase 4: Public Beta and Ecosystem Growth

- launch an ArcPay Mantle X account
